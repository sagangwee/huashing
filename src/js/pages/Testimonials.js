...
export default class Testimonials extends React.Component {
  render() {
    ...
    const reviewer1 = "Kerim C. Cleary on kudzu.com";
    ...
    const reviewer2 = "yakijy on kudzu.com";
    ...
    const testimonialText4 = "Dr. Wang is an excellent practitioner, with a kind patient manner. She can also can mix herbs and perform cupping.";
    const reviewer4 = "Christiana Moore";
